...
\begin{table}[htbp]\centering \caption{Summary statistics for overdose deaths per 100,000 inhabitants \label{tab:sum_deaths}}
...
\begin{tabular}{ccccccc}\hline \hline
 ...
 Control group &  & Before & 12.62 & 6.63 & 3.03 & 45.28 \\
(GA, NC, SC) &  & After & 14.75 & 7.14 & 4.74 & 62.55 \\ \hline
 Texas & 2007 & Before & 10.14 & 6.57 & 1.46 & 41.55 \\
 & & After & 10.38 & 4.99 & 1.80 & 35.45 \\
 Control group & & Before & 17.52 & 9.18 & 4.50 & 46.75 \\
(AR, OK, NM) & & After & 19.99 & 11.49 & 4.59 & 98.15 \\ \hline
 Washington & 2012 & Before & 13.28 & 5.36 & 4.26 & 31.41 \\
  & & After & 13.97 & 4.75 & 5.68 & 26.39 \\
 Control group & & Before & 11.05 & 5.51 & 3.56 & 33.38 \\
(OR, ID, MT) & & After & 12.66 & 5.60 & 3.39 & 30.74 \\
\end{tabular}
...
Control group & & Before & 0.31 & 0.18 & 0.00 & 1.44  \\
(GA, NC, SC) & & After & 0.46 & 0.26 & 0.00 & 2.63 \\ \hline
Washington & 2012 & Before & 0.36 & 0.16 & 0.10 & 0.85 \\
& & After & 0.39 & 0.15 & 0.14 & 0.88 \\
Control group& & Before & 0.29 & 0.17 & 0.00 & 0.90 \\
(OR, ID, MT) & & After & 0.37 & 0.20 & 0.00 & 1.00 \\
\end{tabular}
\end{table}
