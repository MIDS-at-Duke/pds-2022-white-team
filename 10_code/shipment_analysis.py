...
# %% [markdown]
# We selected TN, WV, and NV since those three states are close to Florida and have similar weather
...
g.save("/Users/a563186832/Desktop/pngs/florida_opioid_shipment_diffdiff.png")
print(g)
...
# %%
# Select the states that we want to use as control group
texas_compare = df[df["BUYER_STATE"].isin(["MS", "MT", "CT"])]
...
# %% [markdown]
# From the output, we can conclude that even though the slope of opioid converted amount per caipita is still positive, but value of gradient is smaller. Also, compare to control group, the second derivative is negative for Texas, but positive for the control group. Hence, we may conclude that the policy restrict the opioid converted amount.
...
g.save("/Users/a563186832/Desktop/pngs/washington_opioid_shipment_diffdiff.png")
print(g)
